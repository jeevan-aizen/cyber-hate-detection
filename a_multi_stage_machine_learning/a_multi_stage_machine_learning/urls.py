"""a_multi_stage_machine_learning URL Configuration
...
from a_multi_stage_machine_learning import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Cyber_Hate_Analysis_Type/$', remoteuser.Predict_Cyber_Hate_Analysis_Type, name="Predict_Cyber_Hate_Analysis_Type"),
    ...
    url(r'^View_Predicted_Cyber_Hate_Analysis_Type_Ratio/$', serviceprovider.View_Predicted_Cyber_Hate_Analysis_Type_Ratio, name="View_Predicted_Cyber_Hate_Analysis_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Cyber_Hate_Analysis_Type/$', serviceprovider.View_Predicted_Cyber_Hate_Analysis_Type, name="View_Predicted_Cyber_Hate_Analysis_Type"),
